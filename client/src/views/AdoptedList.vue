<template>
  <div class="col-12 col-lg-12">
        ...
        <div class="row px-0 pt-5" style="background-color: #eee;">
            <div class="col-12">
                <h1 class="text-center">My Adopt List </h1>
            </div>

            <div class="col-12">
                <div class="product-container" v-if="!isEmpty">
            ...
            <!-- <div class="wrapper-images-empty" v-if="isEmpty">
                <div class="images-leaning">
                    <div>
                        <img src="https://images.unsplash.com/photo-1505628346881-b72b27e84530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="Eleanor from The Good Place" />
                    </div>
                    <div>
                        <img src="https://images.unsplash.com/photo-1505628346881-b72b27e84530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="Chidi from The Good Place" />
                    </div>
                    <div>
                        <img src="https://images.unsplash.com/photo-1505628346881-b72b27e84530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="Jason from The Good Place" />
                    </div>
                    <div>
                        <img src="https://images.unsplash.com/photo-1505628346881-b72b27e84530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="Tahani from The Good Place" />
                    </div>
                </div>
            </div> -->
        </div>
